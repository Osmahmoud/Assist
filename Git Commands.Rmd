...
## Merge
If you need to merge a brance, for instance named B1, into the master:
...
You can revert the commits that you have commited correcly (i.e., 1- added; 2- commit) by selecting the commit from the git editor interface and then click simply on revert button.
